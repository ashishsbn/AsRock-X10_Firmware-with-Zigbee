...
int brnf_block_guest = 1;
#endif
#ifdef CONFIG_BRIDGE_X10_DNS_HIJACK
int brnf_block_dns_reply = 0;
#endif
#else
...
#ifdef CONFIG_BRIDGE_X10_GUEST_NETWORK
	{
		.procname	= "bridge-nf-block-guest",
		.data		= &brnf_block_guest,
...
#ifdef CONFIG_BRIDGE_X10_DNS_HIJACK
	{
		.procname	= "bridge-nf-block-dns-reply",
		.data		= &brnf_block_dns_reply,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= brnf_sysctl_call_tables,
	},
