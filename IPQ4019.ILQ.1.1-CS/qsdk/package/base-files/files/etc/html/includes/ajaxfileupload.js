...
jQuery.extend({
    ...
    uploadHttpData: function( r, type ) {
        ...
        if ( type == "json" ) {
          ...
          var final_data = "";
          if (ieVer != -1) {
            // the data is OK, don't need convert
            final_data = data;
          } else {
            var start_index = data.indexOf(">");
            var end_index = data.lastIndexOf("<");
            final_data = data.substring(start_index+1, end_index);
          }
          eval( "data = " + final_data);
        }
