...
function writeDashboardApLanWindow(id)
{
  document.write('\
        ...
        <tr>\
          <td align="center" background="images/box_03.png">\
            <table width="96%" border="0" cellspacing="3" cellpadding="3">' + 
              ...
              dashboardWindowFont("lanIp", DashLANIP) + 
              dashboardWindowFont("lanSubnetMask", AdvSubnetMask) + 
            ...
            <table border="0" cellspacing="0" cellpadding="0">\
              <tr>\
                <td><table width="119" height="39" border="0" cellspacing="0" cellpadding="0">\
                  <tr>\
                    <td class="button1" onclick="setLan()"><a>' + DashApply + '</a></td>\
                  </tr>\
                </table></td>\
                <td>&nbsp;</td>\
                <td><table width="119" height="39" border="0" cellspacing="0" cellpadding="0">\
...
function writeDashboardApWindow(id)
{
          ...
          <td colspan="2" align="center" background="images/box_03.png">\
            <table border="0" cellspacing="0" cellpadding="0">\
              <tr>\
                <td><table width="119" height="39" border="0" cellspacing="0" cellpadding="0">\
                  <tr>\
                    <td class="button1" onclick="setAp()"><a>' + DashApply + '</a></td>\
                  </tr>\
                </table></td>\
                <td>&nbsp;</td>\
                <td><table width="119" height="39" border="0" cellspacing="0" cellpadding="0">\
...
{
  window.open("http://"+window.location.host+"/ap/adv_USB.html", "_self");
}
